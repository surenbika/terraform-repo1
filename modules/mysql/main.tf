...
resource "azurerm_mysql_server" "mysql" {
  ...
  location            = "${module.global_variables.location}" #"${data.azurerm_resource_group.rg.location}"
  resource_group_name = "${module.global_variables.resource_group_name}" #"${data.azurerm_resource_group.rg.name}"
